 ...
 * @author kiku
 */
public class fukugoukensaku extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet fukugoukensaku</title>");            
            out.println("</head>");
            out.println("<body>");
        ...
        try
        {
            ...
            //フォーム情報をレコードに挿入
            db_st = db_con.prepareStatement("select * from profiles where age >= ? and name = ? and birthday = ?"); 
            db_st.setString(1, getAge);
            db_st.setString(2, getName);
            db_st.setString(3, getBirth);
