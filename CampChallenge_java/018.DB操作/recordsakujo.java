 ...
 * @author kiku
 */
public class recordsakujo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet recordsakujo</title>");            
            out.println("</head>");
            out.println("<body>");
        ...
        try
        {
            ...
            db_st = db_con.prepareStatement("delete from profiles where tel = '000-0000-0000'");
