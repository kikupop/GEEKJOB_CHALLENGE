...
public class koushin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet koushin</title>");            
            out.println("</head>");
            out.println("<body>");
        ...
        try
        {
            ...
            db_st = db_con.prepareStatement("update profiles set name = 'Richard', tel = '000-0000-123', age = 5, birthday = '2000-01-01' where profilesID = 6 ");
