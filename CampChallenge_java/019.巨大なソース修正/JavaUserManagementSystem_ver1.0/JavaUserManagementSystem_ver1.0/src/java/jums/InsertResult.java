...
//       UserDataBeans session.getAttribute("hs");
        try{
            //セッションから取り出す変数に入れる
            UserDataBeans userData = (UserDataBeans)session.getAttribute("hs");
            
             String name = userData.getName();
            int yyyy = userData.getYear();
            int mm = userData.getMonth();
            int dd = userData.getDay();
